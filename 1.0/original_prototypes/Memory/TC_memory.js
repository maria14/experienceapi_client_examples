...
var GAME_ID = "act:adlnet.gov/Memory";
...
$(document).ready(function(){
	...
	$('#jugar').click(function(){
		if ($('#tc_nameInput').val() == "" || $('#tc_emailInput').val() == ""){
			...
			document.getElementById('prueba').href="juego.html";
...
var act={"name":"M","mbox":"mailto:MD@gmail.com"};
		...
		var tcGameObj = {
			...
			"definition":{
				"type":"type:media",
				"name":{"en-US":"Js Memory - xAPI Prototype"},
				"description":{"en-US":"A game of Memory."}
            }
        };
        var stmt = {
			"actor":act,
...
function tc_sendStatment_Correct(){
var act={"name":"M","mbox":"mailto:MD@gmail.com"};	
		var tcGameObj = {
            'id':GAME_ID,
			"definition":{
...
function tc_sendStatment_Failed(){
var act={"name":"M","mbox":"mailto:MD@gmail.com"};
		var tcGameObj = {
            'id':GAME_ID,
			"definition":{
